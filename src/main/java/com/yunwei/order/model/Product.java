...
public class Product extends BaseEntity implements Serializable {
	...
	public void setCtimeString(String value) {
		setCtime(DateConvertUtils.parse(value, "yyyy-MM-dd HH:mm:ss",
				Date.class));
	}
	...
	public Integer getIsSellable() {
		return isSellable;
	}

	public void setIsSellable(Integer isSellable) {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
				...
				.append("Ctime", getCtime()).toString();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getProductId(), other.getProductId())
				.isEquals();
	}
}