...
public class OrderGoodsController extends BaseRestSpringController<OrderGoods,java.lang.Long>{
	...
	public String query(ModelMap model, String fieldId,String profileId) throws Exception {
		...
		model.addAttribute("jsonURL", "/ordergoods/index.json");
		model.addAttribute("pageTitle",OrderGoods.TABLE_ALIAS);
		ColModelProfile colModelProfile=colModelFactory.getColModel("OrderGoods-colmodel.xml",profileId);
