...
public class CategoryController extends
		BaseRestSpringController<Category, Long> {
	...
	@RequestMapping
	public String index(ModelMap model, CategoryQuery query,
	...
	@RequestMapping({ "/new" })
	public String _new(ModelMap model, Category category,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
	...
	public String create(ModelMap model, @Valid Category category,
	...
	public String edit(ModelMap model, @PathVariable Long id) throws Exception {
		Category category = (Category) this.categoryManager.getById(id);
		Category pcategory = (Category) this.categoryManager.getById(category
				.getParentId());
		if (pcategory != null) {
	...
	public String update(ModelMap model, @PathVariable Long id,
			@Valid Category category, BindingResult errors,
			HttpServletRequest request, HttpServletResponse response)
			throws Exception {
		if ((category.getParentId() != null)
				&& (category.getParentId().longValue() == category.getCateId()
						.longValue())) {
