...
<%@ include file="/commons/taglibs.jsp" %>
	...
	<tr>	
		...
		<input name="parentIdTxt" id="parentIdTxt" class="input-text small" maxlength="19"  value="${category.parentIdTxt}"/>
	...
	<tr>	
		...
		<td>
		<form:input path="cateName" id="cateName" cssClass="required" maxlength="128" />
