...
CREATE TABLE `stock_record` (
  ...
  `dept_id` int(11) DEFAULT NULL,
  `staff_id` bigint(20) DEFAULT NULL,
  `oper_type` int(1) DEFAULT NULL COMMENT '1=出货\r\n            2=入库\r\n            3=退货\r\n            4=转库',
  `cust_id` bigint(20) DEFAULT NULL,
  ...
  `stock_id` bigint(20) DEFAULT NULL,
  `to_stock_id` bigint(20) DEFAULT NULL,
  `remark` varchar(512) DEFAULT NULL COMMENT '备注',
...
CREATE TABLE `stock_record_line` (
  ...
  `stock_operation_id` bigint(20) DEFAULT NULL,
  `product_id` bigint(20) DEFAULT NULL,
  `price` decimal(10,2) DEFAULT NULL,
...
INSERT INTO `dept` VALUES ('4', '销售部', '0', '销售部');
INSERT INTO `dept` VALUES ('5', '技术部', '0', '技术部');
INSERT INTO `dept` VALUES ('6', '仓库部', '0', '仓库部');
...
INSERT INTO `staff` VALUES ('2', '1', 'Nick', 'Nick', '123', 'Saler', '1', '2013-01-15', '2013-01-08', '2013-01-02', '4412254455', '4412254455', '4412254455', '4412254455@qq.com', '2013-01-28 00:00:00', '1');
INSERT INTO `staff` VALUES ('3', '1', 'Jimmy', 'Jimmy', '1123', '123', '111', '2013-01-16', '2013-01-02', '2013-01-09', '4412254455', '12', '4412254455', '4412254455@qq.com', '2013-01-28 00:00:00', '1');
INSERT INTO `staff` VALUES ('4', '1', 'Jack', 'Jack', '123', '123', '1', '2013-01-01', '2013-01-01', '2013-01-02', '4412254455', '12', '4412254455', '4412254455@qq.com', '2013-01-22 00:00:00', '1');
INSERT INTO `staff` VALUES ('5', '1', 'Steve', 'Steve', '123', '123', '1', '2013-01-07', '2013-01-08', '2013-01-09', '4412254455', '12', '4412254455', '4412254455@qq.com', '2013-01-28 00:00:00', '1');
INSERT INTO `staff` VALUES ('6', '1', 'Sunny', 'Sunny', '123', '123', '1', '2013-01-07', '2013-01-08', '2013-01-02', '4412254455', '12', '4412254455', '4412254455@qq.com', '2013-01-29 00:00:00', '1');
